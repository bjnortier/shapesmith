  ...
  function(
    ...
    var SceneViewMixin = {
      ...
      render: function() {
        ...
        if (radius > 0) {
          var cone = THREE.SceneUtils.createMultiMaterialObject(
            new THREE.CylinderGeometry(0, radius, height, 20, 20),
            [faceMaterial]);
          cone.position = center.clone();
          cone.position.z += height/2;
          cone.rotation.x = Math.PI/2;
          unrotatedSceneObject.add(cone);
        }
